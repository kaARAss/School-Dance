...
export const CARDS_DATA = [
    ...
    },
    {
        ...
        sticker: 'phone',
        title: 'балет',
        services: ['Классический станок', 'Партер', 'Растяжка', 'Осанка и выворотность', 'Пуанты', 'Балет для взрослых', 'Отчётный концерт']
    },
    {
        color: 'orange',
        sticker: 'smiley',
        title: 'heels',
        services: ['Техника на каблуках', 'Пластика', 'Стрип-данс', 'Съёмка номера']
    },
    {
        color: 'maroon',
        sticker: 'hand',
        title: 'contemporary',
        services: ['Импровизация', 'Работа с полом', 'Дыхание и вес', 'Авторские постановки']
    },
    {
        color: 'pink',
        sticker: 'heart',
