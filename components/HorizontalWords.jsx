        ...
        <section ref={sectionRef} className="horizontal-words-section content-section">
            <div className="horizontal-words__relative">
                <div className="horizontal-words__sticker-svg">
                    ...
                    <img src="/assets/HorizontalWords SVG/horizontal-words-sticker-thumps-up.svg" className="horizontal-words__sticker-watch" style={{ transform: "translate(-50%, -142%)" }} alt="стикер класс" />
                    <img src="/assets/HorizontalWords SVG/horizontal-words-sticker-cursor.svg" className="horizontal-words__sticker-cursor" alt="стикер курсор" />
                    <img src="/assets/Card-Sticker SVG/sticker-phone.svg" className="horizontal-words__sticker-phone" style={{ left: "83.5%", transform: "translate(-50%, -118%)" }} alt="стикер с телефоном" />
